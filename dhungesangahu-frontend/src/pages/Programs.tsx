  ...
  return (
    <div className="w-full flex flex-col font-sans bg-slate-50 min-h-screen">
      ...
      <div className="max-w-5xl w-full mx-auto px-6 py-16 flex flex-col items-center">
        ...
        <div className="w-full bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-start text-left relative overflow-hidden transition-all duration-300">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 w-full bg-slate-50 p-6 rounded-2xl border border-slate-200/50">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a 
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full bg-[#652d90] hover:bg-[#4b1f6b] text-white font-bold py-3.5 rounded-xl shadow-md transition-all active:scale-95 text-center text-sm"
              >
