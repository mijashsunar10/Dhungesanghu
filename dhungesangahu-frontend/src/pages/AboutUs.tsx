...
export const AboutUs: React.FC = () => {
  return (
    <div className="w-full flex flex-col font-sans">
      ...
      {/* Intro section */}
      <div className="pt-16 pb-8 px-6 max-w-5xl mx-auto text-left flex flex-col gap-12 w-full">
        {/* Title & Introduction */}
      ...
      {/* Details section */}
      <div className="py-16 px-6 max-w-5xl mx-auto text-left flex flex-col gap-16 w-full">
        {/* Core Values Section */}
